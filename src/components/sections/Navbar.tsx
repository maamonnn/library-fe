export default function NavBar(){
    return(
        <div className="bg-gray-700 top-0 fixed w-full">
        <nav className="flex place-content-between py-3">
          <div className="flex px-6 gap-2 text-white cursor-default">
            ...
            <span>Perpustakaan Bantul</span>
          </div>
          <div className="flex gap-2 px-6 text-white cursor-default">
